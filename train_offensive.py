...
images_dir = '/home/ubuntu/images/offensive'
images_old_dir = '/home/ubuntu/images/offensive_old'
...
for path in files:
	...
	try:
		app.inputs.create_image_from_filename(filename=img_path, concepts=['offensive']) 
	except:
		pass
